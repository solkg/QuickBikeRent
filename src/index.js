...
class Menu extends Component {
  render() {
    return (
      <div>
        <ul style={{border: 'solid', color: 'black'}}>
        <NavLink style={{color: 'black', fontSize: '14px', padding: '5px', textDecoration: 'none'}} to="/">Hjem</NavLink> |
        <NavLink style={{color: 'black', fontSize: '14px', padding: '5px', textDecoration: 'none'}} to="/nykunde">Registrere kunde</NavLink> |
        <NavLink style={{color: 'black', fontSize: '14px', padding: '5px', textDecoration: 'none'}} to="/bestilling">Bestilling</NavLink> |
        <NavLink style={{color: 'black', fontSize: '14px', padding: '5px', textDecoration: 'none'}} to="/bestillingsoversikt">Bestillingsoversiktr</NavLink> |
        <NavLink style={{color: 'black', fontSize: '14px', padding: '5px', textDecoration: 'none'}} to="/sykkelinfo">Sykkelinformasjon</NavLink> |
        <NavLink style={{color: 'black', fontSize: '14px', padding: '5px', textDecoration: 'none'}} to="/kundeinfo">Kundeinformasjon</NavLink> |
        </ul>
      </div>
    );
  }
...
bestillinger = () => {
  this.props.history.push("/bestillinger");
}
...
faq = () => {
  ...
  render() {
    ...
    <br /> <br />
    <img src="sykkel.jpg" width="50%" height="50%"></img>
    <br /> <br />
    <button style={{float: "right"}} onClick={this.faq}>?</button>
    <button style={{float: "right"}} onClick={this.faq}>Feilmelding</button>
    </center>
    </div>
  )};
}
...
class Nykunde extends Component {
  render() {
    ...
    <form>
    Navn: <input type="text"></input> <br />
    Adresse:<input type="text"></input> <br />
    Mobilnummer: <input type="text"></input> <br />
    <br />
    <button>Registrer kunde</button>
    </form>
    </center>
    </div>
  )};
...
class Faq extends Component {
  render() {
    return(
      ...
      <center>
      <h1>
      Ofte stilte spørsmål: -------- Feilmelding
      </h1>
      <p>
      ...
      <textarea rows="14" cols="50" placeholder="Skriv inn feilmelding her så svarer vi så fort som mulig!"></textarea>
      <br />
      <br />
